  		...
  		<div class="row col-md-6 col-md-offset-6">
  			...
  			<div class="row dropdown-toggle">								
  				<a href="javascript:;" class="user-profile" data-toggle="dropdown" aria-expanded="false">
  					<img src="images/img1.jpg" alt=""><span class="name" id="user-name">Andrew Kuktenko</span>
  					...
  					<div class="graph col-md-12">
  						<div class="col-md-12 col-sm-12 col-xs-12">
  							<div>
								...
								<button id="temp" class="btn btn-success btn-lg">
								    Temp
								</button>

								<button id="weight" class="btn btn-success btn-lg">
								    Weight
								</button>
